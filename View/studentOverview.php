...
<div class="col-2 mx-auto mt-4">
    <a href="?page=students&run=create" class="d-inline-block btn btn-primary">Add New Student</a>
    <a href="?page=students&run=export" class="d-inline-block btn btn-primary ml-4">Export</a>
</div>
